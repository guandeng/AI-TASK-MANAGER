...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  manage_language: () => import("@/views/manage/language/index.vue"),
  ...
  "requirement_task-board": () => import("@/views/requirement/task-board/index.vue"),
  "requirement_task-create": () => import("@/views/requirement/task-create/index.vue"),

...
<template>
  <div class="oa-login-container">
    <div class="oa-login-content">
      ...
      <div class="oa-title">
        <h2>AI 任务管理系统</h2>
        <p class="mt-2 text-gray-500">使用 OA 账号快速登录</p>
      </div>

      <NSpace vertical :size="24" class="w-full">
        <NButton type="primary" size="large" round block :loading="loading" @click="handleOaLogin">
          <template #icon>
        ...
        <div class="text-center">
          <NButton text type="primary" @click="openOaPage">打开 OA 系统</NButton>
        </div>
      </NSpace>
    </div>
  </div>
